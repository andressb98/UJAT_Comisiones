/*
  ...
  - Added the required column `folio` to the `Comision` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Comision" ("actualizadoEn", "canceladaEn", "canceladaPorId", "cerradaEn", "cerradaPorId", "claveComision", "creadoEn", "creadorId", "divisionId", "estatus", "fechaFin", "fechaInicio", "frecuenciaRepeticion", "horaFin", "horaInicio", "id", "lugarId", "observaciones", "referencia", "tipoComisionId", "unidadAdministrativaId") SELECT "actualizadoEn", "canceladaEn", "canceladaPorId", "cerradaEn", "cerradaPorId", "claveComision", "creadoEn", "creadorId", "divisionId", "estatus", "fechaFin", "fechaInicio", "frecuenciaRepeticion", "horaFin", "horaInicio", "id", "lugarId", "observaciones", "referencia", "tipoComisionId", "unidadAdministrativaId" FROM "Comision";
DROP TABLE "Comision";
